(function() {
  var Dynasty, Table, aws, debug, lib, typeToAwsType, _,
  ...
  Dynasty = (function() {
    ...
    Dynasty.prototype.alter = function(name, params) {
      ...
      return this.dynamo.updateTable(awsParams).promise();
    };

    Dynasty.prototype.create = function(name, params) {
      ...
      return this.dynamo.createTable(awsParams).promise();
    };
    ...
    Dynasty.prototype.drop = function(name) {
      var params;
      debug("drop() - " + name);
      params = {
        TableName: name
      };
      return this.dynamo.deleteTable(params).promise();
    };
